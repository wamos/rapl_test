...
public:
	...
	std::tuple<double, double, double> getEnergy(int package_num, int time){
		int index = time*2 + package_num; // sec0: 0 1, sec1: 0 1,
...
private:
	...
	int pp1_avail=0;
	int dram_avail=1;
	/* SandyBiedgei*/  int different_units=1;
	/*CPU_BROADWELL_EP, CPU_HASWELL_EP, CPU_SKYLAKE_X*///int different_units=1;
	int psys_avail=0;
	//end case
